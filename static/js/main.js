const currentRoomId = 'living_room';
...
function updateView() {
    ...
    let brightness = (hours < 6 || hours > 21) ? 60 : 115;
...
speakerBtn.onmousedown = startListen;
window.onmouseup = stopListen;
speakerBtn.ontouchstart = startListen;
window.ontouchend = stopListen;
